...
# mkmf -t macOS-gnu10-openmpi.mk -c"-Duse_libMPI -Duse_netCDF" path_names /usr/local/include
...
## -- modify -- Point to local mpi library
FPPFLAGS += "-I/opt/local/include/openmpi-gcc10"
...
## -- modify -- Point to local mpi library
CPPFLAGS += "-I/opt/local/include/openmpi-gcc10"
